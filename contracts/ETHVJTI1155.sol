...
interface IERC1155Receiver is IERC165 {
    ...
    /**
        ...
        @param operator The address which initiated the transfer (i.e. message.sender)
    ...
    */
    ...
    /**
        ...
        @param operator The address which initiated the batch transfer (i.e. message.sender)
        @param from The address which previously owned the token
 ...
 * via message.sender and message.data, they should not be accessed in such a direct
 ...
 * _Available since v3.1._
 */
contract ERC1155 is ERC2771Recipient, ERC165, IERC1155, IERC1155MetadataURI {
...
contract EthVJTI1155 is ERC1155, Ownable {
